...
int zns_write_request(int fd, const void * write_data, int nblocks, __u64 slba)
{
    int result;
...
int zns_write(struct zns_share_info * zonelist, const void * write_data, int data_size, int zone_number, __u64 offset)
{
    int i;
    int result;
    int nblocks;
...
int zns_read(struct zns_share_info * zonelist, void * read_data, int data_size, int zone_number, __u64 offset)
{
    int i;
    int result;
    int nblocks;
    ...
    result = zns_read_request(zonelist->fd, read_data, nblocks, write_lba);
    //zns_update_zone_info(zonelist, zone_number);
